...
from CosSimCalculator import calc_cos_sim
...
process_excel('data/jira_issues_namesfiltered.xlsx', 'data/bert/issues_bert_embeddings.xlsx')
print("Getting Feedback Embeddings")
process_excel('data/feedback_namesremoved.xlsx', 'data/bert/feedback_bert_embeddings.xlsx')
print("Calculating Cosine Similarity")
calc_cos_sim('data/bert/issues_bert_embeddings.xlsx', 'data/bert/feedback_bert_embeddings.xlsx')
