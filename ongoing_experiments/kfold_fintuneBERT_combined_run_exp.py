...
RESULT FILES SAVED:
  ...
  TensorBoard logs are stored in the log directory (e.g., "./logs_kfold").
  MLflow logs the parameters and metrics for each experiment.
"""

import os
os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # Use only the first GPU (index 1)
...
best_preprocessing = {"remove_sw": False, "augment": False, "do_split": False}
